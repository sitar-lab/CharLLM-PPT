...
class GPU(abc.ABC):
    ...
    # CharLLM-PPT
    @abc.abstractmethod
    def getGPUUtilization(self) -> int:
        """Return the current power draw of the GPU. Units: mW."""
        pass

    # CharLLM-PPT
    @abc.abstractmethod
    def getMemoryUtilization(self) -> int:
        """Return the current power draw of the GPU. Units: mW."""
        pass
    ...
    def getTemperature(self) -> int:
        """Return the current temperature of the GPU. Units: Degree C."""
        pass

    # CharLLM-PPT
    @abc.abstractmethod
    def getMemTemperature(self) -> int:
        """Return the current temperature of the GPU Memory. Units: Degree C."""
        pass

    # CharLLM-PPT
    @abc.abstractmethod
    def getSMClock(self) -> int:
        """Return the current SM clock of the GPU. Units: MHz."""
        pass

    # CharLLM-PPT
    @abc.abstractmethod
    def getMemoryClock(self) -> int:
        """Return the current memory clock of the GPU. Units: MHz."""
        pass

    # CharLLM-PPT
    @abc.abstractmethod
    def getInstantMemoryPowerUsage(self) -> int:
        """Return the current power draw of the GPU's memory. Units: mW."""
        pass
    ...
    # CharLLM-PPT
    @abc.abstractmethod
    def getPCIeTxThroughput(self) -> int:
        """Return the current PCIe Tx throughput of the GPU. Units: MB/s."""
        pass

    # CharLLM-PPT
    @abc.abstractmethod
    def getPCIeTxBytes(self) -> int:
        """Return the current PCIe Tx bytes of the GPU. Units: MB."""
        pass

    # CharLLM-PPT
    @abc.abstractmethod
    def getPCIeRxThroughput(self) -> int:
        """Return the current PCIe Rx throughput of the GPU. Units: MB/s."""
        pass

    # CharLLM-PPT
    @abc.abstractmethod
    def getPCIeRxBytes(self) -> int:
        """Return the current PCIe Rx bytes of the GPU. Units: MB."""
        pass

    # CharLLM-PPT
    @abc.abstractmethod
    def getNVLinkTxThroughput(self) -> int:
        """Return the current NVLink Tx throughput of the GPU. Units: MB/s."""
        pass

    # CharLLM-PPT
    @abc.abstractmethod
    def getNVLinkTxBytes(self) -> int:
        """Return the current NVLink Tx bytes of the GPU. Units: MB."""
        pass

    # CharLLM-PPT
    @abc.abstractmethod
    def getNVLinkRxThroughput(self) -> int:
        """Return the current NVLink Rx throughput of the GPU. Units: MB/s."""
        pass

    # CharLLM-PPT
    @abc.abstractmethod
    def getNVLinkRxBytes(self) -> int:
        """Return the current NVLink Rx bytes of the GPU. Units: MB."""
        pass
...
class GPUs(abc.ABC):
    ...
    # CharLLM-PPT
    def getGPUUtilization(self, gpu_index: int) -> int:
        """Return the current compute utilization of GPU. Units: %."""
        return self.gpus[gpu_index].getGPUUtilization()

    # CharLLM-PPT
    def getMemoryUtilization(self, gpu_index: int) -> int:
        """Return the current memory utilization of GPU. Units: %."""
        return self.gpus[gpu_index].getMemoryUtilization()

    # CharLLM-PPT
    def getTemperature(self, gpu_index: int) -> int:
        """Return the current temperature of the GPU. Units: Degree C."""
        return self.gpus[gpu_index].getTemperature()

    # CharLLM-PPT
    def getMemTemperature(self, gpu_index: int) -> int:
        """Return the current temperature of the GPU Memory. Units: Degree C."""
        return self.gpus[gpu_index].getMemTemperature()

    # CharLLM-PPT
    def getSMClock(self, gpu_index: int) -> int:
        """Return the current SM clock of the GPU. Units: MHz."""
        return self.gpus[gpu_index].getSMClock()

    # CharLLM-PPT
    def getMemoryClock(self, gpu_index: int) -> int:
        """Return the current memory clock of the GPU. Units: MHz."""
        return self.gpus[gpu_index].getMemoryClock()

    # CharLLM-PPT
    def getInstantMemoryPowerUsage(self, gpu_index: int) -> int:
        """Return the current power draw of the GPU's memory. Units: mW."""
        return self.gpus[gpu_index].getInstantMemoryPowerUsage()
    ...
    # CharLLM-PPT
    def getPCIeTxThroughput(self, gpu_index: int) -> int:
        """Return the current PCIe Tx throughput of the GPU. Units: MB/s."""
        return self.gpus[gpu_index].getPCIeTxThroughput()

    # CharLLM-PPT
    def getPCIeTxBytes(self, gpu_index: int) -> int:
        """Return the current PCIe Tx bytes of the GPU. Units: MB."""
        return self.gpus[gpu_index].getPCIeTxBytes()

    # CharLLM-PPT
    def getPCIeRxThroughput(self, gpu_index: int) -> int:
        """Return the current PCIe Rx throughput of the GPU. Units: MB/s."""
        return self.gpus[gpu_index].getPCIeRxThroughput()

    # CharLLM-PPT
    def getPCIeRxBytes(self, gpu_index: int) -> int:
        """Return the current PCIe Rx bytes of the GPU. Units: MB."""
        return self.gpus[gpu_index].getPCIeRxBytes()

    # CharLLM-PPT
    def getNVLinkTxThroughput(self, gpu_index: int) -> int:
        """Return the current NVLink Tx throughput of the GPU. Units: MB/s."""
        return self.gpus[gpu_index].getNVLinkTxThroughput()

    # CharLLM-PPT
    def getNVLinkTxBytes(self, gpu_index: int) -> int:
        """Return the current NVLink Tx bytes of the GPU. Units: MB."""
        return self.gpus[gpu_index].getNVLinkTxBytes()

    # CharLLM-PPT
    def getNVLinkRxThroughput(self, gpu_index: int) -> int:
        """Return the current NVLink Rx throughput of the GPU. Units: MB/s."""
        return self.gpus[gpu_index].getNVLinkRxThroughput()

    # CharLLM-PPT
    def getNVLinkRxBytes(self, gpu_index: int) -> int:
        """Return the current NVLink Rx bytes of the GPU. Units: MB."""
        return self.gpus[gpu_index].getNVLinkRxBytes
