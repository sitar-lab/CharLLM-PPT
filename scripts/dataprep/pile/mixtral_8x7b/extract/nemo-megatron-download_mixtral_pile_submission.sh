...
#SBATCH --array=0-0%1
#SBATCH -C L40S
#SBATCH --error=${CHARLLM_ROOT}/CharLLM-PPT/results/download_mixtral_pile/extract/log-nemo-megatron-download_mixtral_pile.out
#SBATCH --gpus-per-node=8
#SBATCH --job-name=nemo-megatron-download_mixtral_pile
#SBATCH --mem=0
#SBATCH --nodes=1
#SBATCH --output=${CHARLLM_ROOT}/CharLLM-PPT/results/download_mixtral_pile/extract/log-nemo-megatron-download_mixtral_pile.out
#SBATCH --time=1:00:00
...
# command 1
srun --output ${CHARLLM_ROOT}/CharLLM-PPT/results/download_mixtral_pile/extract/log-nemo-megatron-download_mixtral_pile.out --error ${CHARLLM_ROOT}/CharLLM-PPT/results/download_mixtral_pile/extract/log-nemo-megatron-download_mixtral_pile.out bash -c "
