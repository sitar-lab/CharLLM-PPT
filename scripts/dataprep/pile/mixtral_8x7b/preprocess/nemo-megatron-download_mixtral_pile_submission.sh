...
#SBATCH --array=0-0%1
#SBATCH -C L40S
#SBATCH --error=${CHARLLM_ROOT}/CharLLM-PPT/results/download_mixtral_pile/preprocess/log-nemo-megatron-download_mixtral_pile.out
#SBATCH --exclusive
...
#SBATCH --output=${CHARLLM_ROOT}/CharLLM-PPT/results/download_mixtral_pile/preprocess/log-nemo-megatron-download_mixtral_pile.out
#SBATCH --time=1:00:00
...
srun --output ${CHARLLM_ROOT}/CharLLM-PPT/results/download_mixtral_pile/preprocess/log-nemo-megatron-download_mixtral_pile.out --error ${CHARLLM_ROOT}/CharLLM-PPT/results/download_mixtral_pile/preprocess/log-nemo-megatron-download_mixtral_pile.out bash -c "
