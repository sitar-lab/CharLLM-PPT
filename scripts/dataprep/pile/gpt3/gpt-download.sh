...
#SBATCH --array=0-0%1
#SBATCH -C H200
#SBATCH --error=${CHARLLM_ROOT}/CharLLM-PPT/results/download_gpt3_pile/combined/log-nemo-megatron-download_gpt3_pile.err
#SBATCH --gpus-per-node=4
#SBATCH --job-name=gpt3_pile_pipeline
#SBATCH --mem=0
#SBATCH --nodes=1
#SBATCH --cpus-per-gpu=8
#SBATCH --output=${CHARLLM_ROOT}/CharLLM-PPT/results/download_gpt3_pile/combined/log-nemo-megatron-download_gpt3_pile.out
#SBATCH --time=2:00:00
