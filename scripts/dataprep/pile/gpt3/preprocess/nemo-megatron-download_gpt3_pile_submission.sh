...
# Parameters
#SBATCH --array=0-0%1
#SBATCH --dependency=aftercorr:673023
#SBATCH -C L40S
#SBATCH --error=${CHARLLM_ROOT}/CharLLM-PPT/results/download_gpt3_pile/preprocess/log-nemo-megatron-download_gpt3_pile.err
#SBATCH --gpus-per-node=8
#SBATCH --exclusive
#SBATCH --job-name=nemo-megatron-download_gpt3_pile
#SBATCH --mem=0
#SBATCH --nodes=1
#SBATCH --output=${CHARLLM_ROOT}/CharLLM-PPT/results/download_gpt3_pile/preprocess/log-nemo-megatron-download_gpt3_pile.out
#SBATCH --time=1:00:00
...
srun --output ${CHARLLM_ROOT}/CharLLM-PPT/results/download_gpt3_pile/preprocess/log-nemo-megatron-download_gpt3_pile.out --error ${CHARLLM_ROOT}/CharLLM-PPT/results/download_gpt3_pile/preprocess/log-nemo-megatron-download_gpt3_pile.err bash -c "
