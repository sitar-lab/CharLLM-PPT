...
# Parameters
#SBATCH --error=${CHARLLM_ROOT}/CharLLM-PPT/results/inference/gpt3-175b/gpt3-175b_3_mbs1-h200.err
#SBATCH -C H200
#SBATCH --nodelist=${CHARLLM_H200_NODELIST}
#SBATCH --gpus-per-node=8
#SBATCH --partition=${CHARLLM_PARTITION}
#SBATCH --job-name=nemo-megatron-gpt3-gpt3-175b_3_mbs1
#SBATCH --mem=0
#SBATCH --nodes=4
#SBATCH --ntasks-per-node=8
#SBATCH --cpus-per-task=8
#SBATCH --output=${CHARLLM_ROOT}/CharLLM-PPT/results/inference/gpt3-175b/gpt3-175b_3_mbs1-h200.out
...
# Zeus Arguments
export ZEUS_CSV_PATH=${CHARLLM_ROOT}/CharLLM-PPT/results/inference/gpt3-175b/gpt3-175b_3_mbs1
export ZEUS_MONITOR_ENABLED=1
export ZEUS_MONITOR_SYS=1

mkdir -p $ZEUS_CSV_PATH

srun --output ${CHARLLM_ROOT}/CharLLM-PPT/results/inference/gpt3-175b/gpt3-175b_3_mbs1-h200.out --error ${CHARLLM_ROOT}/CharLLM-PPT/results/inference/gpt3-175b/gpt3-175b_3_mbs1-h200.err --mpi=pmix bash -c "
  ...
  --config-name=gpt3-175b_3_mbs1.yaml \
  "
