...
# Parameters
#SBATCH --error=${CHARLLM_ROOT}/CharLLM-PPT/results/microbatch-sweep-h200/llama3-70b/llama3-70b_1_mbs2-h200.err
#SBATCH -C H200
...
#SBATCH --output=${CHARLLM_ROOT}/CharLLM-PPT/results/microbatch-sweep-h200/llama3-70b/llama3-70b_1_mbs2-h200.out
...
# Zeus Arguments
export ZEUS_CSV_PATH=${CHARLLM_ROOT}/CharLLM-PPT/results/microbatch-sweep-h200/llama3-70b/llama3-70b_1_mbs2
export ZEUS_MONITOR_ENABLED=1
export ZEUS_MONITOR_SYS=1

mkdir -p $ZEUS_CSV_PATH

srun --output ${CHARLLM_ROOT}/CharLLM-PPT/results/microbatch-sweep-h200/llama3-70b/llama3-70b_1_mbs2-h200.out --error ${CHARLLM_ROOT}/CharLLM-PPT/results/microbatch-sweep-h200/llama3-70b/llama3-70b_1_mbs2-h200.err --mpi=pmix bash -c "
