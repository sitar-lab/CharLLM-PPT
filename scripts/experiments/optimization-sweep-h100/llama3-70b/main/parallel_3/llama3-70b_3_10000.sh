...
# Parameters
#SBATCH --error=${CHARLLM_ROOT}/CharLLM-PPT/results/optimization-sweep-h100/llama3-70b/llama3-70b_3_10000-h100.err
#SBATCH -C H100
...
#SBATCH --output=${CHARLLM_ROOT}/CharLLM-PPT/results/optimization-sweep-h100/llama3-70b/llama3-70b_3_10000-h100.out
...
# Zeus Arguments
export ZEUS_CSV_PATH=${CHARLLM_ROOT}/CharLLM-PPT/results/optimization-sweep-h100/llama3-70b/llama3-70b_3_10000
export ZEUS_MONITOR_ENABLED=1
export ZEUS_MONITOR_SYS=1

mkdir -p $ZEUS_CSV_PATH

srun --output ${CHARLLM_ROOT}/CharLLM-PPT/results/optimization-sweep-h100/llama3-70b/llama3-70b_3_10000-h100.out --error ${CHARLLM_ROOT}/CharLLM-PPT/results/optimization-sweep-h100/llama3-70b/llama3-70b_3_10000-h100.err --mpi=pmix bash -c "
  ...
  --config-name=llama3-70b_3_10000.yaml \
  "
