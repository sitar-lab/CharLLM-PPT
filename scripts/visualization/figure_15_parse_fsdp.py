...
def parse_large_json(file_path):
    """Parse a large JSON trace file and extract top kernels with a progress bar."""
    top_kernels = []
...
def process_kineto_traces(model_name, base_dir):
    ...
    for exp_dir in experiment_dirs:
        ...
        print(f"Using kineto directory: {os.path.basename(latest_kineto_dir)}")
...
def main():
    ...
    # Define paths
    base_dir = "${CHARLLM_ROOT}/CharLLM-PPT/results/microbatch-sweep-h200-fsdp"
    output_dir = "${CHARLLM_ROOT}/CharLLM-PPT/results/kineto-microbatch-sweep-h200-fsdp"
