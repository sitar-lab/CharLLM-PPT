...
MP_DIR=${CHARLLM_ROOT}/CharLLM-PPT/scripts/experiments/microbatch-sweep-h200
FSDP_DIR=${CHARLLM_ROOT}/CharLLM-PPT/scripts/experiments/microbatch-sweep-h200-fsdp
